...
void LCD_Print_fdot( int16_t intd){
  char Humi_Str[7];
//only 4digit like 00.00 this type only
  Humi_Str[0] = (intd/10000)%10 + 48; // Extract 0xxxx digit
  Humi_Str[1] = (intd/1000)%10 + 48; // Extract 0xxxx digit
  Humi_Str[2] = (intd/100)%10 + 48; // Extract 0xxxx digit
  Humi_Str[3] = '.'; // Extract 0xxxx digit
  Humi_Str[4] = (intd/10)%10 + 48; // Extract 0xxxx digit
  Humi_Str[5] = (intd)%10 + 48; // Extract 0xxxx digit
  Humi_Str[6] = 0;               // String Terminator
